...
| `docs/` | Projectinventaris & GitHub-sync-handleiding.【F:docs/project_inventory.md†L1-L96】【F:docs/sync_github.md†L1-L98】 |
| `scripts/` | Sync-helpers voor GitHub (branch of volledige mirror).【F:scripts/sync_github.sh†L1-L40】【F:scripts/sync_github_full.sh†L1-L35】 |
